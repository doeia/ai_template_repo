...
def find_faces_euclidean_distance(input_path: str, display_output: bool = False):
    """
    Find face in the database of loaded faces using the Euclidean distance metric.
    """
    output = []
    output_info = []
    ...
    for idx, face_location, face_encoding in face_recognition_tools.grab_Faces(img=frame, model=MODEL):
        ...
        similarFaces = face_recognition_tools.searchSimilarFaces_Euclidean(
            dbFaceID, DISTANCE)
